...
img = Image.open("in it to win it.png")  # Replace "bank_image.jpg" with the actual path to your image
...
Label(master, text="IN IT TO WIN IT BANK", font=('Calibri', 14)).grid(row=0, sticky=N, pady=10)

Label(master, text="Our victory is certain", font=('Calibri', 12)).grid(row=1, sticky=N)
